...
public class PenguinAnalyzer {
    ...
    public void writePenguins() {
        ...
        try (PrintWriter writer =
            ...
            System.out.println(
                "Penguin data successfully "
                + "written to PenguinOutput.txt.");
